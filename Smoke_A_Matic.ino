...
double consKp=2.5, consKi=.10, consKd=.05;
...
pinMode(11, OUTPUT);
  ...
  pidsample = 8000; // used to make the pid sample time adjustable
...
void loop() {
  ...
  ////////////////////////////////////////////////////////////
   ///////////////////////////////////////////////////////////
   // ran out of i/o (at the time)so automanswitch and screenindex use analog inputs
   // I was using 11 for a pc fan
 
   
      
     if (analogRead(A1) < 500){//the Unos ADC has a 10bit resolution
      automanswitch = 0;}       //this means 5vdc would equal roughly 1023
    else{                     //so 500 is the middle of both 0 and 5vdc
      automanswitch = 1;} 
  ...
  if (screen > 8){screen = 0;} // limits the screen number and starts it back to 0
