...
I'm sorry I lied in my youtube video about eeprom saving servo positions
it would be a useless function anyways.
...
Next turn you automan switch to manual, then scrol through the menu and set your 
...
double consKp=2.5, consKi=.06, consKd= 2.5;
...
int outpulse; // pulsed output for low speed fan use
long prepulse; // counter for pulse interval
int prange;// percentage range of output to be pulsed
////////////////////////////////////////////////////////////////////////////////////
...
pinMode(A2, INPUT);
 ...
 // servofulclosed = 128; // sets the closed position of servo in degrees
  ...
  pidsample = 10000; // used to make the pid sample time adjustable
  buttondelay = 1000;// how long button is held before fast indexing. you can choose how long hear
  prange = 30; // percentage range of output to be pulsed
}
...
void loop() {
  ...
  ////////////////////////////////////////////////////////////
  //Temp  logic hold switch and update delay, used to keep the temp 
  ...
  if (screen > 6){screen = 0;} // limits the screen number and starts it back to 0
...
// screen 0 to start us off. asks if you want to load from epprom 
 ...
 /*  // screen 7 used for finding servo open position /////////////
  if (screen == 7){
   ...
   // screen 8 used for finding servo closed position //////////
  if (screen == 8){
    lcd.setCursor(0, 0);
...
*/
 //////////////////////////////////////////////////////////
  ...
  if (outputperc<=prange){
      if(outpulse==1){analogWrite(11 ,255);}  // if it's too slow, pulse it
  else{digitalWrite(11, LOW);}  // you can change this ^ value (above) to set your fan speed during pulse
  }
